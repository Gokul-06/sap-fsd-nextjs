...
export function StructuredRequirements({
  ...
  return (
    <div className="space-y-3">
                      ...
                      <div className="px-4 pb-4 pt-0">
                        <div className="relative group/textarea">
                          <Textarea
                            ...
                            rows={field.rows || 3}
                            className="resize-y text-sm border-slate-200 focus:border-[#0091DA] focus:ring-[#0091DA]/20 bg-slate-50/50 rounded-lg pr-10"
                          />
                          <button
                            type="button"
                            onClick={() => setExpandedModal(field.id)}
                            className="absolute top-2 right-2 p-1.5 rounded-md bg-white/80 border border-slate-200 text-slate-400 hover:text-[#0091DA] hover:border-[#0091DA]/30 hover:bg-[#0091DA]/5 transition-all opacity-0 group-hover/textarea:opacity-100 focus:opacity-100 shadow-sm"
                            title="Expand editor"
                          >
      ...
      <AnimatePresence>
        {expandedModal && (() => {
          const field = FIELDS.find((f) => f.id === expandedModal);
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[85vh] flex flex-col overflow-hidden border border-slate-200"
              >
                {/* Modal header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-xl bg-[#0091DA]/10 text-[#0091DA]">
                      {field.icon}
                    </div>
                    <div>
                ...
                <div className="flex-1 p-6 overflow-hidden">
                  <textarea
                    ...
                    value={fieldValues[field.id] || ""}
                    onChange={(e) => updateField(field.id, e.target.value)}
                    className="w-full h-full min-h-[300px] resize-none text-sm leading-relaxed p-4 rounded-xl border border-slate-200 focus:border-[#0091DA] focus:ring-2 focus:ring-[#0091DA]/20 outline-none bg-slate-50/50 transition-all placeholder:text-slate-400"
                ...
                <div className="flex items-center justify-between px-6 py-3 border-t border-slate-100 bg-slate-50/50">
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    <Sparkles className="h-3 w-3 text-[#0091DA]" />
                    <span>Tip: Be as detailed as possible for richer FSD output</span>
                  </div>
                  <button
                    type="button"
                    onClick={() => setExpandedModal(null)}
                    className="px-4 py-2 text-sm font-medium bg-[#0091DA] text-white rounded-lg hover:bg-[#007AB8] transition-colors shadow-sm"
                  >
                    Done
                  </button>
                </div>
